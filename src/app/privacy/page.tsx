        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-neutral-600 dark:text-neutral-400">
              Email: <a href="mailto:privacidade@termyx.com.br" className="text-blue-600 hover:underline">privacidade@termyx.com.br</a>
            </p>
            <p className="text-neutral-600 dark:text-neutral-400 mt-2">
              Encarregado de Dados (DPO): <a href="mailto:dpo@termyx.com.br" className="text-blue-600 hover:underline">dpo@termyx.com.br</a>
            </p>
          </section>
        </div>
