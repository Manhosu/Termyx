// Run SQL migrations using Supabase Management API
// This requires a Supabase access token from: https://supabase.com/dashboard/account/tokens
...
if (!SUPABASE_ACCESS_TOKEN) {
  ...
  console.error('3. Run: set SUPABASE_ACCESS_TOKEN=your_token_here && node scripts/run-sql-migrations.mjs')
  console.error('\nAlternatively, you can execute the SQL commands manually:')
  console.error('Go to: https://supabase.com/dashboard/project/xekjxblesgdrnqaxpjwx/sql/new')
  console.error('And copy-paste the SQL commands from the files created.')
  process.exit(1)
}
...
async function main() {
  console.log('🚀 Executing SQL commands on Supabase via Management API...\n')
